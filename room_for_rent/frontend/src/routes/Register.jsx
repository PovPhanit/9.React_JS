    ...
    <div className=' w-full h-[100vh] p-5  flex justify-center items-center'>
      <div className='lg:w-[50%] py-9  lg:h-[520px] hidden lg:flex lg:flex-col lg:justify-center lg:items-end'>
        ...
        <motion.div
            ...
            transition={{ duration: 3,scale:1.5}}
           >
      ...
      <div className='flex flex-col items-center w-[98%]  py-9 lg:w-[50%]'>
        ...
        <div className='text-center mt-[-20px]'>
          <div className='mb-[20px]'>
              ...
              <h3 className='text-[17px]'>Create to your account</h3>
          </div>
          <form action="" className='flex flex-col items-center gap-5 mb-[7px]'>
            ...
            <div className='w-full relative'>
             <input type="email" className='h-9 rounded-lg indent-[45px] w-full outline-4 border-b border-blue-400 drop-shadow-lg focus:outline-none focus:border-b focus:border-b-blue-400'  placeholder='Email'/>
                 <AiOutlineMail  className='absolute text-blue-400  text-[27px] bg-white top-[-6px] left-[-10px] p-2 w-12 h-12 rounded-[50%] border-2 border-blue-400 drop-shadow-2xl'/>
            </div>
            <div className='w-full relative'>
            ...
            <button type="submit" className='bg-blue-400 px-3 py-1 rounded-md text-white'>Sign up</button>
          </form>
          Already have an account? <Link to="/login" className='text-blue-700'>sign in here</Link>
       </div>
